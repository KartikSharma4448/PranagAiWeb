import { Download, Share2, Heart, Shield, Syringe, Bell, FolderOpen } from "lucide-react";
    ...
    <section id="dashboard" ref={ref} className="py-20 lg:py-28">
      <div className="container">
        <div className="text-center mb-14">
          <p className="text-primary font-semibold text-sm uppercase tracking-wider mb-2">Health Reports</p>
          <h2 className="font-display text-3xl sm:text-4xl font-bold">
            Reports & <span className="text-gradient-gold">Digital Records</span>
          </h2>
          <p className="text-muted-foreground mt-3 max-w-lg mx-auto">
            After each scan, the app generates health insights, risk status, recommendations, and alerts for timely action.
          </p>
        </div>
          ...
          <div className="rounded-[2rem] border-4 border-foreground/20 bg-card shadow-2xl overflow-hidden">
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  { label: "Skin", value: "Normal", color: "text-primary" },
                  { label: "Respiratory", value: "Low Risk", color: "text-primary" },
              ...
              <div className="space-y-2">
                {[
                  ...
                  { icon: FolderOpen, label: "Scan History", value: "12 Scans", sub: "Last: 2 days ago" },
